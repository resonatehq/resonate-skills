...
description: Core patterns for writing durable generator functions with Context APIs - function invocations, promises, sleep, determinism, and structured concurrency. Use this inside function* bodies for durable, recoverable execution.
---
